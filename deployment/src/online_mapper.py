...
class OnlineTopologicalMapper:
    def __init__(self, map_name="y_graph"):
        ...
        # 🔴 核心参数精调
        self.dist_thresh = 1.2   # 直道上的正常节点间距
    ...
    def image_callback(self, msg):
        ...
        # ---------------------------------------------------------
        # 🎯 动作 1：绝对空间吸附 (霸道总裁版)
        # 只要你在这个圈里，不管你怎么倒车、掉头、打转，我都当你是瞎折腾，绝对不建图！
        # ---------------------------------------------------------
        ...
        # 🔴 关键魔法：如果你是在开辟新岔路，只要离开路口 0.65 米，立刻拍一张“面包屑过渡帧”！
        # 如果是顺着老路直走，就按规矩等 1.0 米再拍。
...
if __name__ == '__main__':
    ...
    parser.add_argument("--map", type=str, default="y_graph", help="Name of the map to save")
    # 使用 parse_known_args 防止 ros 传进来的额外参数导致解析错误
